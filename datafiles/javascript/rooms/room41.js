...
// import UnlockBubble from "../objects/bases/UnlockBase.js"
...
export default class room41 extends LevelRoom {
	constructor() {
		...
		this.addBubble(new Bubble(150, 150, 1, 1, 150));

		this.addBubble(new Bubble(500, 650, 2, 1, 10));
		this.addBubble(new Bubble(1000, 500, 2, 10, 100));
