...
export default class room4 extends LevelRoom {
	constructor(g) {
		super(g);
		...
		for(let i = 0; i < 3; i++) {
			for(let j = 0; j < itemsInRow; j++) {
				...
				this.addBubble(new Bubble(this.g, startMargin + j * planetDistance, 160 + i * planetDistance, newTeam, newSize, newUnits));
			}
		}
	}
}
