class room8 extends LevelRoom {
	constructor() {
		...
		this.planetlist[4] = this.addToObjList(new Bubble(760, 650, 0, 1));
		this.planetlist[5] = this.addToObjList(new Bubble(384, 300, 0, 1));
		this.planetlist[6] = this.addToObjList(new Bubble(800, 480, 0 , 1));
		this.planetlist[7] = this.addToObjList(new Bubble(100, 128, 1, 1));
		this.planetlist[8] = this.addToObjList(new Bubble(1120, 200, 2, 2, 100));
	}
