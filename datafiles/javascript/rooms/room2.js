class room2 extends LevelRoom {
	constructor(){
		...
		this.bubbles[0] = this.addObject(new Bubble(128, 640, 1, 2, 100));
		this.bubbles[1] = this.addObject(new Bubble(1184, 288));
		this.bubbles[2] = this.addObject(new Bubble(736, 224));
		this.bubbles[3] = this.addObject(new Bubble(1024, 544, 4, 1, 150));
		...
		this.bubbles[7] = this.addObject(new Bubble(64, 160, 3, 2, 100));
		this.bubbles[8] = this.addObject(new Bubble(1120, 128, 2, 2, 100));
	}
}
